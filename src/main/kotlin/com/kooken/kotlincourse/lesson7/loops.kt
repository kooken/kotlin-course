...
fun nestedLoop() {
    ...
    for (i in 1..10) {
        for (j in 1..10) {
            print(i * j)  // Вывод результата умножения
            print(" ")    // Пробел для разделения значений
        }
        println()  // Пустая строка для перехода на новую строку после каждого прохода внешнего цикла
    }
